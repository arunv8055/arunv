  ...
  return <section className="h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="flex flex-col items-center">
          ...
          <h1 className="heading-xl text-balance animate-fade-in" style={{
          animationDelay: "0.5s"
        }}>
          ...
          animationDelay: "1.1s"
            ...
            <Link to="/contact" className="px-8 py-3 rounded-full bg-primary text-white font-medium transition-all hover:bg-primary/90 hover:shadow-lg">
              Get in Touch
            </Link>
            <Link to="/projects" className="px-8 py-3 rounded-full border border-border text-foreground font-medium transition-all hover:bg-secondary">
              View Projects
            </Link>
          </div>
